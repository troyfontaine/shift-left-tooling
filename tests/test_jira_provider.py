...
class TestJiraProvider:
    ...
    @mock.patch("lib.jira_provider.get_config")
    @mock.patch("lib.jira_provider.JIRA")
    def test_validate_ticket_exists_true(
        self, mock_jira_client, mock_get_config
    ):
    ...
    @mock.patch("lib.jira_provider.get_config")
    @mock.patch("lib.jira_provider.JIRA")
    def test_validate_ticket_exists_false(
        self, mock_jira_client, mock_get_config
    ):
    ...
    def test_init_with_explicit_credentials(
        ...
        provider = JiraProvider(
            url="https://custom.jira.com", token="custom-token"
        )
